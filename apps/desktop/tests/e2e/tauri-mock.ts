  ...
  pods: [
    {
      ...
      qos_class: "Burstable",
      containers: [
        { name: "worker", image: "ghcr.io/x/worker:2.1", ready: true },
        { name: "envoy", image: "ghcr.io/x/envoy:1.29", ready: true },
        { name: "init-migrate", image: "ghcr.io/x/init-migrate:1.0", ready: true },
      ],
      labels: { app: "api" },
